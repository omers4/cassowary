...
class BinaryReader(BaseReader):
    ...
    def read_user(self):
        ...
        user_name = binary_from_stream(self.file, f'{user_name_length}s')[
            0].decode('ASCII')
    ...
    def next_snapshot(self):
        timestamp, translation_x, translation_y, translation_z, rotation_x, \
        ...
        depth_pixels = binary_from_stream(self.file,
                                          f'{depth_height * depth_width}f')

        hunger, thirst, exhaustion, happiness = binary_from_stream(self.file,
                                                                   'ffff')
